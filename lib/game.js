...
var BoardVariation = require('./board_variation').BoardVariation;
var Color = require('./color').Color;
var EventLog = require('./event_log').EventLog;
var Fen = require('./fen').Fen;
var Flags = require('./flags').Flags;
var LinkedHashMap = require('./linked_hash_map').LinkedHashMap;
